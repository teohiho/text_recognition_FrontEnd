        ...
        <SafeAreaView style={ styles.container }>
          ...
          <TouchableOpacity onPress={this.handleChangeOrigin}>
            <View style={ styles.avatarWrap }>
              ...
              <Image style={ styles.imgAvatar } source={ require('./app/resource/imgs/avatar1.png') }/>
            </View>
          </TouchableOpacity>
          ...
          {checkTextReturn != 1 && (
            <TouchableOpacity style={ styles.itemContainer } onPress={this.handleChoosePhoto}>
              ...
              <Image style={ styles.itemIcon } source={ require('./app/resource/imgs/ic_default.png') }/>
            </TouchableOpacity>
          )}
          ...
          <ScrollView style={ styles.fill }>
            ...
            <View style={ styles.footer }>
              <Image style={{ width: 402, height: 150}} source={ require('./app/resource/imgs/ic_presentation.png') }/>
            </View>
          </ScrollView>
        </SafeAreaView>
      </View>
